		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#clouddnawalkthroughclouddnaui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"clouddnawalkthroughclouddnaui5-display": {
								"semanticObject": "clouddnawalkthroughclouddnaui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=clouddna.walkthrough.clouddnaui5",
									"url": sap.ui.require.toUrl("clouddna/walkthrough/clouddnaui5")
								}
							}
						}
					}
